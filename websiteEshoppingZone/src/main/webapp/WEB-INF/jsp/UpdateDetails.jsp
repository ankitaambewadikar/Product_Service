                    ...
                    <table>
                        <jstl:forEach var="rating" items="${product.rating}">
                            <tr style="font-style: italic;">
                                <td><input name="rating" value=${rating.key} readonly="readonly" /></td>
                                <td><input name="rating" value=${rating.value} /></td>
                            </tr>
                        </jstl:forEach>   
                    </table>   
                </td>
                <td>
                    <table>
                        <jstl:forEach var="review" items="${product.review}">
                            <tr style="font-style: italic;">
                                <td><input name="rating" value=${review.key} readonly="readonly" /></td>
                                <td><input name="rating" value=${review.value} /></td>
                            </tr>
                        </jstl:forEach>   
                    </table>
                </td>
				...
				<td>
                    <table>
                        <jstl:forEach var="specification" items="${product.specification}">
                            <tr style="font-style: italic;">
                                <td><input name="specification" value=${specification.key}  /></td>
                                <td><input name="specification" value=${specification.value} /></td>
                            </tr>
                        </jstl:forEach> 
                       </table>
                 </td>
